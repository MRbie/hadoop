...
/** 
* @author  Author:别先生 
* @date Date:2017年12月16日 下午4:39:43 
*
* 1:将清洗之后的日志梳理出点击流pageviews模型数据
* 2:输入数据是清洗过后的结果数据
* 3:区分出每一次会话，给每一次visit（session）增加了session-id（随机uuid）
* 4:梳理出每一次会话中所访问的每个页面（请求时间，url，停留时长，以及该页面在这次session中的序号）
* 5:保留referral_url，body_bytes_send，useragent
* 
*/
